...
export default function Tracks() {
  const tracksList = [
    ...
    },
    {
      id: "ai-ml",
      name: "AI&ML",
      description: "Dive deep into artificial intelligence and machine learning. Build models for predictive analysis, NLP workflows, and explore neural network structures.",
      level: "Advanced",
      duration: "16 Weeks",
      skills: ["Python", "TensorFlow", "PyTorch", "NLP", "Neural Networks", "Model Deployment"],
      badgeColor: "text-amber-400 bg-amber-500/10 border-amber-500/20",
    },
    {
      id: "data-science",
      name: "Data Science & Analytics",
      description: "Master data manipulation and analytical techniques. Clean datasets, perform regression analysis, and build insightful visualizations.",
      level: "Intermediate",
      duration: "12 Weeks",
      skills: ["Python", "Pandas/NumPy", "SQL", "Tableau/PowerBI", "Data Cleaning", "Statistics"],
          ...
          {tracksList.map((track) => (
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-xl font-bold text-white group-hover:text-vortex-cyan transition-colors">
                  {track.name}
                </h3>
